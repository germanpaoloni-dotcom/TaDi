...
const designs = [
  ...
  require("./cumpleanos/asadito-fernet"),
  require("./cumpleanos/noche-de-vino"),
  require("./cumpleanos/pool-party"),
  require("./cumpleanos/jazz-vinilo"),
  require("./bautismos/tadi"),
